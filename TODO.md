# TODO: Port Snake Game to Web and Deploy to Vercel

- [x] Create index.html: Main HTML file with a canvas element for the game.
- [x] Create style.css: Basic styling for the game window and UI.
